...
import TasksHomePage from './home-components/TasksHomePage';
...
import {
  ...
  heightScreen,
  widthScreen,
} from './home-styles/HomeScreenStyle';
    ...
    Alert.alert('Delete', `Do you want to delete ${title}?`, [
      {
        ...
        onPress: () => {
          this.setState({
            carouselItems: this.state.carouselItems.filter(
              (carousel) => carousel.title !== title
            ),
          });
