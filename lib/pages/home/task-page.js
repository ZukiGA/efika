...
import Graph from '../progress/progress-components/IndividualGraph';
    ...
    return (
      <ScrollView style={styles.taskScreenStyles}>
        <FocusAwareStatusBar
          ...
          backgroundColor={this.state.darkerColor}
        />
        <View
          style={[
            styles.topSquare,
            { backgroundColor: this.state.brighterColor },
          ]}
        ></View>
        ...
        <View
          style={[styles.yourdaysSquare, { borderColor: this.state.mainColor }]}
        ></View>
