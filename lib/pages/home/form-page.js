...
class FormPage extends React.Component {
  ...
  changeModalTimeActive = () => {
    this.setState((prevState) => ({
      modalTimeActive: !prevState.modalTimeActive,
    }));
  };
  ...
  openModal = (title, elementToChange) => {
    ...
    if (
      (elemCuantification[0].status &&
        elemCuantification[0].key === elementToChange) ||
      (elemCuantification[1].status &&
        elemCuantification[1].key === elementToChange)
    ) {
      this.setState((prevState) => ({
        repeat: 0,
        time: 0,
          ...
          <View style={styles.screenStyle}>
            {modalActive ? (
              <ModalView
                ...
                changeElem={(newElem, element) =>
                  this.changeElem(newElem, element)
                }
                title={modalTitle}
                  ...
                  <View style={styles.habitsIconsView}>
                    ...
                    >
                      <MaterialIcons
                        name="today"
                        size={75}
                        color={elemRepetition[0].status ? softBlue : strongGrey}
                      />
                    ...
                    >
                      <MaterialCommunityIcons
                        name="calendar-week"
                        size={75}
                        color={elemRepetition[1].status ? softBlue : strongGrey}
                      />
                    ...
                    >
                      <MaterialCommunityIcons
                        name="calendar-month"
                        size={75}
                        color={elemRepetition[2].status ? softBlue : strongGrey}
                      />
                    ...
                    <View style={styles.cuantificacionViewStyle}>
                      ...
                      <View style={styles.habitsIconsView}>
                        ...
                        <TouchableOpacity
                          style={styles.iconStyle}
                          onPress={() =>
                            this.openModal("Pick repetitions", "repeat")
                          }
                        >
                          <MaterialCommunityIcons
                            name="repeat"
