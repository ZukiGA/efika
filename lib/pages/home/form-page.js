        ...
        <ScrollView style={styles.scrollViewStyle}>
          <View>
            ...
            <View style={styles.bottomElements}>
              ...
              >
                <Text>En esta sección puedes decidir cada cuanto quieres repetir tu hábito</Text>
                <Text />
                <Text> Escogiendo &quot;día&quot; podrás decidir qué días de la semana para realizar tu meta </Text>
                <Text />
                <Text>Si escoges &quot;semana&quot; o &quot;mes&quot; tendrás todo ese período para realizar tu meta. Puedes combinarlo con una cuantificación para mayor efectividad</Text>
              </Popover>
              ...
              {switchEnabled ? (
                <View style={styles.cuantificacionViewStyle}>
                  ...
                  >
                    <Text>Esta opción te da una forma de cuantificar tu meta, ya sea en repeticiones o en tiempo</Text>
                    <Text />
                    <Text>Estas cuantificaciones puedes ir apilandolas. Por ejemplo si tu repetición es de un mes, puedes ir haciendo 2 minutos por día y al final tendrás 60 minutos</Text>
                  </Popover>
                  <View style={styles.habitsIconsView}>
                    <TouchableOpacity
                      style={styles.iconStyle}
