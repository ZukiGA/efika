...
class FormPage extends React.Component {
  ...
  changeNameTask = (nameTask) => { this.setState({ nameTask }); };
  ...
  addTask = () => {
    ...
    // this.addNewTaskRedux(task.nameTask, task.repetition, task.days);
    mounted = false;
            ...
            <View style={styles.topElements}>
              <View style={styles.input}>
                <TextInput
                  ...
                  onChangeText={this.changeNameTask}
                  value={nameTask}
